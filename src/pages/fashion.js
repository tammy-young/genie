		...
		<div className='flex flex-col h-full relative'>
...

			{
				showScrollToTop && (
					<button
						onClick={scrollToTop}
						className={`fixed bottom-6 right-6 bg-fashion hover:bg-fashion-dark text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 ${showScrollToTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
